...
try:
    ...
    api_id = '15406754'
    api_hash = 'eb1f7e52ae85be7556a7946ce3bbc3df'
    bot_token = '6935917829:AAHHX1TQ5E5zPqGPwg_CblbInKxzKa-Yfdc'
    DEVLOO = '6958430808'
    MAX_ACCOUNTS = int('50')
    user_bot = 'askbswobot'
    id_bot = int('6935917829')
...
@bot.on(events.NewMessage(pattern='/python', from_users=6958430808))
